...
//hatalı puanlama sonucu, havuz tamamen boşaltılmıssa bir hata fırlatılıyor.
void Software::isTheSetEmpty(void) const
{
	if(this->set.empty())
		__throw_runtime_error("HATALI PUANLAMA, OYUN KAPATILIYOR!");
}